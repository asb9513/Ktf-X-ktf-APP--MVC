...
class ClothesVC:UIViewController {
    ...
    func loadproblem(){
        ...
        NetworkApi.sendRequest(method: .get, url: showproblem_clothes, completion:
...
extension ClothesVC:UITableViewDataSource,UITableViewDelegate {
    
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if tableView == ClothesTV{
        return items.count
        }
        else {
