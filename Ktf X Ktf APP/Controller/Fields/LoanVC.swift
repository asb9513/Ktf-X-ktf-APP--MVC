...
class LoanVC: UIViewController {
    ...
    static func instance () -> LoanVC {
        let storyboard = UIStoryboard.init(name: "Fields", bundle: nil)
        return storyboard.instantiateViewController(withIdentifier: "LoanVC") as! LoanVC
    }
    ...
    func loadproblem(){
        ...
        NetworkApi.sendRequest(method: .get, url: showproblem_Loan, completion:
    ...
    @IBAction func AddProblemButtonAction(_ sender: Any) {
        let post = LoanPostProblemVC.instance()
...
extension LoanVC:UITableViewDataSource,UITableViewDelegate {
