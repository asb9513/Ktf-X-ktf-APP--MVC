...
import Photos
import Alamofire
class PostProblemVC: UIViewController {
    
    
    let debuggingTag = "PostProblemVC"
    
    static func instance () -> PostProblemVC {
        let storyboard = UIStoryboard.init(name: "Fields", bundle: nil)
        return storyboard.instantiateViewController(withIdentifier: "PostProblemVC") as! PostProblemVC
    }
...
extension PostProblemVC: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
