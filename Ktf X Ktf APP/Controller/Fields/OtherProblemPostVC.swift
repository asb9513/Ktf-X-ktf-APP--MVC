...
import Alamofire
import Photos
class OtherProblemPostVC: UIViewController {
    
    static func instance () -> OtherProblemPostVC {
        let storyboard = UIStoryboard.init(name: "Fields", bundle: nil)
        return storyboard.instantiateViewController(withIdentifier: "OtherProblemPostVC") as! OtherProblemPostVC
    }
...
extension OtherProblemPostVC: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
