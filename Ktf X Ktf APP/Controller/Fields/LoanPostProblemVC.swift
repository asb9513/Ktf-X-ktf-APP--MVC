...
import Photos
import Alamofire
class LoanPostProblemVC: UIViewController {
    
    static func instance () -> LoanPostProblemVC {
        let storyboard = UIStoryboard.init(name: "Fields", bundle: nil)
        return storyboard.instantiateViewController(withIdentifier: "LoanPostProblemVC") as! LoanPostProblemVC
    }
    ...
    let debuggingTag = "LoanPostProblemVC"
...
extension LoanPostProblemVC: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
